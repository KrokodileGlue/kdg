...
main(int argc, char **argv)
{
	...
	ktre *re = ktre_compile(kdgu_news("[[:digit:][:lower:][:xdigit:]b]+"), KTRE_UNANCHORED | KTRE_GLOBAL | KTRE_DEBUG);
	if (!re->err)
		ktre_exec(re, kdgu_news("i love Βίβλος γενέσεως Ἰησοῦ Χριστοῦ 3 lamp i love Βίβλος γενέσεως Ἰησοῦ Χριστοῦ 3 lamp"), NULL);
